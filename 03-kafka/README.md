...
Kafka consumer and procuder apps recipe for [Mau](https://mau.nestjs.com).
...
3. Within that project, create two applications: Kafka producer and Kafka consumer.
4. Create: Kafka broker.
