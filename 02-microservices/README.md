...
Multiple services recipe for [Mau](https://mau.nestjs.com).
...
3. Within that project, create as many applications as you need (one for each of the applications listed above).
4. Create: Redis database, RabbitMQ broker, and NATS broker.
5. Now one by one, generate API keys for each application and run the following commands to deploy this recipe to the cloud:
